        ...
        <div className="mr-[2rem]">
          ...
          <label htmlFor="video" style={{ cursor: "pointer" }}>
            {selectedVideo ? (
              ...
              <div
                className="w-64 h-48 relative border-2 border-sky-400  rounded-lg flex items-center justify-center cursor-pointer"
              ...
              >
                <div className="border-2 border-sky-400 bg-[#DDF4FF] mt-9 rounded-lg">
        ...
        <div className="mt-[2rem]">
          ...
          {textData?.bodyStyles ? (
            <div
              ...
              className={`h-[5rem] w-[50rem] ${textData?.bodyStyles.bold ? "font-bold" : ""
